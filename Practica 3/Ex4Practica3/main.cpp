...
int main(int argc, char** argv) {
    try {
        ...
        BalancedBSTContactFinder balancedBSTContact;
        ...
        balancedBSTContact.appendContactList(fitxer);
        ...
        while (!isf.eof()) {
            ...
            balancedBSTContact.findContact(cognom);
        ...
        cout <<"La profunditat de l'arbre és: " <<  balancedBSTContact.height() << endl;
