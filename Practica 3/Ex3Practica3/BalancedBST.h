...
template <class E> class BalancedBST{
    public:
        ...
        void printPreorder() const {if (this->empty()) cout << "Arbol vacio" << endl;
                                    else this->printPreorder (this->rootB);};
        void printPostorder() const {if (this->empty()) cout << "Arbol vacio" << endl;
                                    else this->printPostorder (this->rootB);};
        void printInorder() const {if (this->empty()) cout << "Arbol vacio" << endl;
...
template <class E> void BalancedBST<E>::insert(const E& element) {
    if (this->empty()) {
...
template <class E> bool BalancedBST<E>::search(const E& element) const {
    NodeTree <E>* guide = this->rootB;
